# space_app.py — HuggingFace Spaces deployment
...
demo = gr.Interface(
    fn=lambda text: summarize(text, model, tokenizer),
    inputs=gr.Textbox(
        lines=10,
    ...
    description="Paste a clinical medical report and get a plain-English patient summary. Built with Transformer from scratch + fine-tuned BART.",
    examples=[
        ...
        ["A 45-year-old female presented with sudden onset severe headache and photophobia. CT scan showed subarachnoid hemorrhage. CT angiography revealed a 7mm aneurysm. Surgical clipping was performed successfully."],
    ],
)
